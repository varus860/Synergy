...
const LoginPage = () => {
    ...
    const handleSubmit = useCallback((e) => {
        ...
        setIsLoading(true);
        print(`Attempting login for: ${email}`, 'info');
    ...
    }, [navigate, email, password, setIsLoading]);
                    ...
                    <div className="max-w-[480px] mx-auto">
                        <header className="mb-12 text-center">
                            ...
                            <p className="text-[1.1rem] text-text-secondary leading-[1.65]">
                                Sign in to your portal to manage your medical supplies.
                            </p>
                        </header>
                        ...
                        <div className="border border-gray-200 rounded-[12px] p-6 md:p-10 bg-white shadow-sm animate-in fade-in slide-in-from-bottom-2 duration-500">
                            ...
                            <div className="flex items-center my-8">
                                ...
                                <span className="px-4 text-[0.75rem] text-text-secondary font-black uppercase tracking-widest">OR</span>
                                <div className="flex-1 h-px bg-gray-100"></div>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    <label className="block text-[0.8125rem] font-bold text-text-secondary uppercase tracking-[0.1em]">
                                        Password
                                    </label>
                                    <input
                                        type="password"
                            ...
                            <div className="mt-10 p-4 bg-gray-50 rounded-[8px] border border-gray-100 border-l-[3px] border-l-trust-blue/40">
                                <p className="text-[0.8125rem] text-text-secondary leading-[1.6]">
                                    Use <span className="font-bold text-text-primary">'demo@example.com'</span> and any password for testing. This is a demonstration portal.
                                </p>
                            </div>
                        </div>
