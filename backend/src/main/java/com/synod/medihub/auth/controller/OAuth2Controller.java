...
import com.synod.medihub.auth.services.OAuth2Service;
...
public class OAuth2Controller {
    ...
    @GetMapping("/success")
    public void callbackOAuth2(@AuthenticationPrincipal OAuth2User oAuth2User, HttpServletResponse response) throws IOException, IOException {
